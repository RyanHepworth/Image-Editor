...
class PositionFrame(ctk.CTkFrame):
    def __init__(self, parent, pos_vars):
        ...
        SliderPanel(self, 'Rotation', pos_vars['rotate'], 0, 360).pack()
        SliderPanel(self, 'Zoom', pos_vars['zoom'],  0, 300).pack()
...
class ColorFrame(ctk.CTkFrame):
    def __init__(self, parent, color_vars):
        ...
        SliderPanel(self, 'Brightness', color_vars['brightness'], 0, 5).pack()
        SliderPanel(self, 'Vibrance', color_vars['vibrance'], 0, 5).pack()
        RevertButton(self, 
...
class EffectFrame(ctk.CTkFrame):
    ...
    def __init__(self, parent, effect_vars):
        ...
        DropDownPanel(self, effect_vars['effect'], EFFECT_OPTIONS).pack()
        SliderPanel(self, 'Blur', effect_vars['blur'], 0, 30).pack()
        SliderPanel(self, 'Contrast', effect_vars['contrast'], 0, 10).pack()
