...
class App(ctk.CTk):
	def __init__(self):
		...
		self.geometry('1000x600+1200+100')
	...
	def manipulate_image(self, *args):
		...
		if self.pos_vars['zoom'].get() != ZOOM_DEFAULT:
			self.image = ImageOps.crop(self.image, border=self.pos_vars['zoom'].get())
	...
	def place_image(self):
		...
		self.image_output.create_image(self.image_width/2, self.image_height/2, image= self.image_tk)
